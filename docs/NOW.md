...
2. **The privacy note for the account record** (item 0 above). The earliest gate in the whole sign-in plan — it blocks any self-serve signup in *either* tier, including Ben's own school. **With the six decisions below taken, this is now the only thing gating the sign-in work.**
