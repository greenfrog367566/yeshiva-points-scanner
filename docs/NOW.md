...
**5. The tab-audit punch list — `docs/UI_Theory_Tab_Audit.md`, PARTIALLY CLOSED.** 27 ranked findings from the 2026-08-14 six-agent audit. 9 of 27 are done: 4 shipped quietly in commit `0bf9778` (2026-08-14), and **PR #301 (merged 2026-08-18)** closed 5 more — Review-group landing tab, Shorashim emoji default, Settings card reorder, Leader Board banner drop, Text-tab setup collapse. Remaining: the 2 bugs (Mishnayos silently teaching Pesukim content; Store's stale pending-count), the Trends dead-Sheet-button and Auction audit-log-write items, the 5 "Tracked Items" internal-term copy fixes, and the rest of the disclosure-and-cockpit list (full list and code locations in the doc; **line numbers drift, re-verify before acting**). Still nothing here is scheduled — pull individual items opportunistically.
